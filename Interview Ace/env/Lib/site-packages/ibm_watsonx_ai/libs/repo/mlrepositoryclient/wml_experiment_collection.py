...
from ibm_watsonx_ai.libs.repo.mlrepositoryartifact.experiment_artifact import ExperimentArtifact
...
from ibm_watsonx_ai.libs.repo.swagger_client.models import ExperimentInput,TagRepository,\
    ExperimentInputSettings,MetricObjectExperiments,HyperParametersOptimizationExperiments,EvaluationDefinitionExperiments
from ibm_watsonx_ai.libs.repo.swagger_client.models import TrainingReferenceExperiments,ComputeConfigurationExperiments
from ibm_watsonx_ai.libs.repo.swagger_client.models import  ConnectionObjectTargetExperiments,ConnectionObjectSourceExperiments,AuthorExperiments, PatchOperationExperiments, HyperParametersExperiments
from ibm_watsonx_ai.libs.repo.swagger_client.models import HyperParametersOptimizationExperimentsMethodParameters, HyperParametersOptimizationExperimentsMethod, \
...
class WmlExperimentCollection:
    ...
    def get(self, experiment):
        ...
        if(experiment.__contains__("/v3/experiments")):
            matched = re.search(r'.*/v3/experiments/([A-Za-z0-9\-]+)', experiment)
