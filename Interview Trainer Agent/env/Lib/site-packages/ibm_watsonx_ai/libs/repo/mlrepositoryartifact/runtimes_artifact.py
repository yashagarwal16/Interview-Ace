...
from ibm_watsonx_ai.libs.repo.mlrepository import MetaNames, MetaProps, WmlRuntimesArtifact
from ibm_watsonx_ai.libs.repo.mlrepositoryartifact.runtimes_artifact_reader import RuntimesArtifactReader
