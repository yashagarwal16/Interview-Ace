...
from ibm_watsonx_ai.libs.repo.mlrepositoryartifact.function_artifact import FunctionArtifact
from ibm_watsonx_ai.libs.repo.swagger_client.models.ml_assets_create_function_input import MlAssetsCreateFunctionInput
from ibm_watsonx_ai.libs.repo.swagger_client.models import TagRepository
from ibm_watsonx_ai.libs.repo.swagger_client.models import PatchOperationFunctions
...
class FunctionCollection:
    ...
    def revision_from_href(self, artifact_revision_href, expand = None):
        ...
        matched = re.search(r'.*/v4/functions/([A-Za-z0-9\-]+)/revisions/([A-Za-z0-9\-]+)',
    ...
    def save(self, artifact):
        ...
        try:
            ...
            if function_id is None:
                ...
                location_match = re.search(r'.*/v4/functions/([A-Za-z0-9\\-]+)', location)
    ...
    def remove(self, function_id):
        ...
        if(function_id.__contains__("/v4/functions")):
            matched = re.search(r'.*/v4/functions/([A-Za-z0-9\-]+)', function_id)
            if matched is not None:
