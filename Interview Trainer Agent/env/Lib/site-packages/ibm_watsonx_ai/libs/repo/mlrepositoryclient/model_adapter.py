...
from ibm_watsonx_ai.libs.repo.mlrepository import MetaNames, MetaProps
from ibm_watsonx_ai.libs.repo.mlrepository.scikit_model_artifact import ScikitModelArtifact
from ibm_watsonx_ai.libs.repo.mlrepository.tensorflow_model_artifact import TensorflowModelArtifact
from ibm_watsonx_ai.libs.repo.mlrepository.generic_archive_model_artifact import GenericArchiveModelArtifact
from ibm_watsonx_ai.libs.repo.mlrepositoryartifact import SparkPipelineModelLoader, SparkPipelineModelContentLoader,\
    IBMSparkPipelineModelContentLoader, MLPipelineModelContentLoader
from ibm_watsonx_ai.libs.repo.mlrepositoryartifact.content_loaders import ScikitPipelineModelContentLoader,TensorflowPipelineModelContentLoader
from ibm_watsonx_ai.libs.repo.mlrepositoryartifact.scikit_pipeline_model_loader import ScikitPipelineModelLoader
from ibm_watsonx_ai.libs.repo.mlrepositoryartifact.tensorflow_pipeline_model_loader import TensorflowPipelineModelLoader
from ibm_watsonx_ai.libs.repo.mlrepositoryartifact.generic_file_pipeline_model_loader import GenericFilePipelineModelLoader
from ibm_watsonx_ai.libs.repo.mlrepositoryartifact.hybrid_pipeline_model_artifact import HybridPipelineModelArtifact
from ibm_watsonx_ai.libs.repo.mlrepositoryartifact.hybrid_pipeline_model_loader import  HybridPipelineModelLoader
from ibm_watsonx_ai.libs.repo.swagger_client.models import AuthorRepository
from ibm_watsonx_ai.libs.repo.util.generic_archive_file_check import GenericArchiveFrameworkCheck
import ast,json
...
class ModelAdapter(object):
    ...
    def artifact(self):
        ...
        if self.model_metadata.id is not None and href_tmp is None:
            ...
            if self.model_metadata.project_id:
            ...
            if metrics := self.model_entity.get('metrics') is not None:
                prop_map[MetaNames.METRICS] = metrics
