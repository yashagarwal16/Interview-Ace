...
from ibm_watsonx_ai.libs.repo.swagger_client.models import ModelInput, ModelVersionInput, ModelTrainingDataRef, ModelVersionOutput, ModelDefinitionModels, \
...
from ibm_watsonx_ai.libs.repo.swagger_client.models import EvaluationDefinitionMetrics, ConnectionObjectWithNameRepository, ArrayDataInputRepository, EvaluationDefinitionRepositoryMetrics
from ibm_watsonx_ai.libs.repo.swagger_client.models import MlAssetsCreateModelInput, FrameworkOutputRepository, AuthorRepository, EvaluationDefinitionRepository, FrameworkOutputRepositoryLibraries,FrameworkOutputRepositoryRuntimes
from ibm_watsonx_ai.libs.repo.swagger_client.models import ContentLocation,HyperParameters
from ibm_watsonx_ai.libs.repo.util.json_2_object_mapper import Json2ObjectMapper
from ibm_watsonx_ai.libs.repo.util.exceptions import UnsupportedTFSerializationFormat,InvalidCaffeModelArchive
from ibm_watsonx_ai.libs.repo.swagger_client.models import  MlAssetsModelSizeOutput
...
class ModelCollection:
    ...
    def version_from_href(self, artifact_version_href):
        ...
        matched = re.search(r'.*/v3/ml_assets/models/([A-Za-z0-9\-]+)/versions/([A-Za-z0-9\-]+)',
                            artifact_version_href)
        matchedV2 = re.search(r'.*/v2/artifacts/models/([A-Za-z0-9\-]+)/versions/([A-Za-z0-9\-]+)',
                              artifact_version_href)
    ...
    def _get_experiment_id_from_url(self, artifact_version_url):
        ...
        matched = re.search(
            r'.*/v3/ml_assets/training_definitions/([A-Za-z0-9\-]+)/versions/([A-Za-z0-9\-]+)', artifact_version_url)
        if matched is not None:
