...
from ibm_watsonx_ai.libs.repo.mlrepository import MetaNames, PipelineArtifact
from ibm_watsonx_ai.libs.repo.swagger_client.api_client import ApiException
from ibm_watsonx_ai.libs.repo.swagger_client.models import TagRepository,MlAssetsCreateExperimentInput, MlAssetsCreateModelInput, \
    MlAssetsCreateModelOutput , MlAssetsCreateExperimentOutput

from ibm_watsonx_ai.libs.repo.util import  Json2ObjectMapper
import json
from .experiment_adapter import ExperimentAdapter
from ibm_watsonx_ai.libs.repo.swagger_client.models.author_repository import AuthorRepository
from ibm_watsonx_ai.libs.repo.swagger_client.models.framework_output_repository import FrameworkOutputRepository
from ibm_watsonx_ai.libs.repo.swagger_client.models.connection_object_with_name_repository import ConnectionObjectWithNameRepository
from ibm_watsonx_ai.libs.repo.swagger_client.models.ml_assets_create_experiment_input import MlAssetsCreateExperimentInput
from ibm_watsonx_ai.libs.repo.swagger_client.models.array_data_input_repository import  ArrayDataInputRepository
from ibm_watsonx_ai.libs.repo.swagger_client.models.framework_output_repository_runtimes import  FrameworkOutputRepositoryRuntimes
from ibm_watsonx_ai.libs.repo.swagger_client.models.framework_output_repository_libraries import  FrameworkOutputRepositoryLibraries
from ibm_watsonx_ai.libs.repo.mlrepositoryartifact.generic_archive_pipeline_model_artifact import GenericArchivePipelineModelArtifact
...
class ExperimentCollection:
    ...
    def __init__(self, base_path, repository_api, client):
        ...
        from ibm_watsonx_ai.libs.repo.mlrepositoryclient import MLRepositoryApi
    ...
    def version_from_url(self, artifact_version_url):
        ...
        matchedV2 = re.search(
            r'.*/v4/pipelines/([A-Za-z0-9\-]+)$', artifact_version_url)

        matchedV3 = re.search(
            r'.*/v4/pipelines/([A-Za-z0-9\-]+)?rev=([A-Za-z0-9\-]+)', artifact_version_url)
